...
public class PrestadorServiciosEFException extends BusinessException {
    ...
    public final static String EMAIL_INCORRECTO = "err007";

    public PrestadorServiciosEFException(String messageKey) {
        super(messageKey);
    }
}
