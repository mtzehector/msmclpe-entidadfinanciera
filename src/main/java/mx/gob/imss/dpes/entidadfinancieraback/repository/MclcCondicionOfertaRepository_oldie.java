 ...
 */
public interface MclcCondicionOfertaRepository_oldie extends JpaRepository<MclcCondicionOfertaOldie, Long>, 
        JpaSpecificationExecutor<MclcCondicionOfertaOldie>{
