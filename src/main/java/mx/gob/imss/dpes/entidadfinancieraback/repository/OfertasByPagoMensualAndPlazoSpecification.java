 ...
 */
public class OfertasByPagoMensualAndPlazoSpecification extends BaseSpecification<MclcCondicionOfertaOldie> {

    private final Pensionado pensionado;
    private final double descuentoMensual;
    private final Long plazo;
    public OfertasByPagoMensualAndPlazoSpecification(Pensionado pensionado, double monto, Long plazo) {
        this.pensionado = pensionado;
        this.descuentoMensual = monto;
        this.plazo = plazo;
    }
    ...
    public Predicate toPredicate(Root<MclcCondicionOfertaOldie> root, CriteriaQuery<?> cq,
        ...
        return cb.and(
                ...
                cb.ge(join.get(MclcCondicionEntfed_.monMaximo),
                        cb.prod( descuentoMensual, root.get(MclcCondicionOfertaOldie_.mclcPlazo).get(MclcPlazo_.numMeses))),
